...
BEGIN
        ...
        INSERT INTO DAYS_notifications (day_id, when_date, when_time) VALUES (NEW.id, '1 day' , '12 : 00');
	INSERT INTO DAYS_notifications (day_id, when_date, when_time) VALUES (NEW.id, '1 week', '12 : 00');
        -- acces rights
