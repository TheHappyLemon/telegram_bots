...
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user)         VALUES(64, 'Change name'       , 'change_evnt_name', 2, NULL, 1,  5, 0, 'MODIFY_E_NM'                      );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(9 , 'Change date'       , 'change_date'     , 2, NULL, 2,  5, 0, 'MODIFY_DATE', 'is_event_regular'  );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user)         VALUES(10, 'Change description', 'change_desc'     , 2, NULL, 3,  5, 0, 'MODIFY_DESC'                      );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(11, 'Change period'     , 'change_period'   , 2, NULL, 4,  5, 0, 'MODIFY_PER', 'is_event_regular,is_event_continious');
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(12, 'Change amount'     , 'change_amount'   , 2, NULL, 5,  5, 0, 'MODIFY_AMT', 'is_event_regular,is_event_continious');
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(48, 'Change weekday'    , 'change_weekday'  , 2, NULL, 6,  5, 0, 'MODIFY_WKD', 'is_event_irregular' );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(49, 'Change occurence'  , 'change_occurence', 2, NULL, 7,  5, 0, 'MODIFY_OCR', 'is_event_irregular' );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(50, 'Change month'      , 'change_month'    , 2, NULL, 8,  5, 0, 'MODIFY_MTH', 'is_event_irregular' );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(61, 'Change start date' , 'change_date'     , 2, NULL, 9,  5, 0, 'MODIFY_BGN', 'is_event_continious');
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(62, 'Change end date'   , 'change_date'     , 2, NULL, 10, 5, 0, 'MODIFY_END', 'is_event_continious');
