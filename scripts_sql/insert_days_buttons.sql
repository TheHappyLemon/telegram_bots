...
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(11, 'Change period'     , 'change_period'   , 2, NULL, 3, 5, 0, 'MODIFY_PER', 'is_event_regular'   );
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user, showif) VALUES(12, 'Change amount'     , 'change_amount'   , 2, NULL, 4, 5, 0, 'MODIFY_AMT', 'is_event_regular'   );
...
INSERT INTO DAYS_buttons (id, text, func, group_num, nextGroup, ordr, parent_id, accs_lvl, sts_user)         VALUES(51, 'Back'              , NULL              , 2, 1   , 10, 5, 0, 'IDLE'                             );
